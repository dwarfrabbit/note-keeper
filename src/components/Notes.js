...
renderHeader() {
    return (
        <div className="card-header">
            <Routes>
                <Route exact path="/node" element={ <Link to="/">
                    <button type="button" className="btn btn-danger">Cancel Note</button>
                </Link>} />

                {["/", "/note/:id"].map(path => <Route key={path} exact path={path} element={
                    <Link to="/note">
        ...
        <Routes>
            {editMode ? (
                <Route exact path="/note/:id"
                    //element={<NewNotes persistNote={this.addNote} note={this.getEmptyNote()} />}
                    element={<NewNotes persistNote={this.saveEditedNote} deleteNote={this.deleteNote} note={this.state.selectedNote} />}
                />
            ) : (
                <Route exact path="/note/:id"
                    //element={<NewNotes persistNote={this.saveEditedNote} deleteNote={this.deleteNote} note={this.state.selectedNote} />}
                    element={<EditNotes editNote={this.openEditNote} deleteNote={this.deleteNote} note={this.state.selectedNote} />}
                />
            )}
